...
public class AlgoTest {
	...
	public void constructionDUnReseauSansProbleme() {
		...
		try {
			...
			gnb.addStationToRoute(m1, gnb.addStation(2,"Grande Arche de la Défense"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(3,"Esplanade de la Défense"), 0);
			...
			gnb.addStationToRoute(m1, gnb.addStation(8,"Charles de Gaulle, Étoile"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(9,"George V"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(10,"Franklin D. Roosevelt"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(11,"Champs Élysées, Clémenceau"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(12,"Concorde"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(13,"Tuileries"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(14,"Palais Royal, Musée du Louvre"), 0);
			...
			gnb.addStationToRoute(m1, gnb.addStation(18,"Saint-Paul, Le Marais"), 0);
			...
			gnb.addStationToRoute(m1, gnb.addStation(23,"Porte de Vincennes"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(24,"Saint-Mandé, Tourelle"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(25,"Bérault"), 0);
			gnb.addStationToRoute(m1, gnb.addStation(26,"Château de Vincennes"), 0);

			gnb.addStationToRoute(m2, gnb.addStation(27,"Porte Dauphine"), 0);
			gnb.addStationToRoute(m2, gnb.addStation(28,"Victor Hugo"), 0);
			gnb.addStationToRoute(m2, gnb.addStation(29,"Charles de Gaulle, Étoile"), 0);
			...
			gnb.addStationToRoute(m2, gnb.addStation(39,"Barbès Rochechouart"), 0);
			...
			gnb.addStationToRoute(m2, gnb.addStation(48,"Philippe-Auguste"), 0);
			...
			gnb.addStationToRoute(m3, gnb.addStation(52,"Pont de Levallois, Bécon"), 0);
			gnb.addStationToRoute(m3, gnb.addStation(53,"Anatole France"), 0);
			gnb.addStationToRoute(m3, gnb.addStation(54,"Louise Michel"), 0);
			gnb.addStationToRoute(m3, gnb.addStation(55,"Porte de Champerret"), 0);
			...
			gnb.addStationToRoute(m3, gnb.addStation(64,"Quatre Septembre"), 0);
			gnb.addStationToRoute(m3, gnb.addStation(65,"Bourse"), 0);
			gnb.addStationToRoute(m3, gnb.addStation(66,"Sentier"), 0);
			gnb.addStationToRoute(m3, gnb.addStation(67,"Réaumur Sébastopol"), 0);
			...
			gnb.addStationToRoute(m3, gnb.addStation(75,"Porte de Bagnolet"), 0);
			gnb.addStationToRoute(m3, gnb.addStation(76,"Galliéni"), 0);
			
			gnb.addStationToRoute(m4, gnb.addStation(77,"Porte de Clignancourt"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(78,"Simplon"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(79,"Marcadet Poissonniers"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(80,"Château Rouge"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(81,"Barbès Rochechouart"), 0);
			...
			gnb.addStationToRoute(m4, gnb.addStation(85,"Strasbourg Saint-Denis"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(86,"Réaumur Sébastopol"), 0);
			...
			gnb.addStationToRoute(m4, gnb.addStation(93,"Saint-Germain-des-Prés"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(94,"Saint-Sulpice"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(95,"Saint-Placide"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(96,"Montparnasse Bienvenue"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(97,"Vavin"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(98,"Raspail"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(99,"Denfert Rochereau"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(100,"Mouton-Duvernet"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(101,"Alésia"), 0);
			gnb.addStationToRoute(m4, gnb.addStation(102,"Porte d'Orléans"), 0);
			
			gnb.addStationToRoute(m5, gnb.addStation(103,"Bobigny, Pablo Picasso"), 0);
			gnb.addStationToRoute(m5, gnb.addStation(104,"Bobigny-Pantin, Raymond Queneau"), 0);
			gnb.addStationToRoute(m5, gnb.addStation(105,"Église de Pantin"), 0);
			gnb.addStationToRoute(m5, gnb.addStation(106,"Hoche"), 0);
			gnb.addStationToRoute(m5, gnb.addStation(107,"Porte de Pantin"), 0);
			...
			gnb.addStationToRoute(m5, gnb.addStation(114,"Jacques Bonsergent"), 0);
			...
			gnb.addStationToRoute(m5, gnb.addStation(120,"Quai de la Rapée"), 0);
			gnb.addStationToRoute(m5, gnb.addStation(121,"Gare d'Austerlitz"), 0);
			...
			gnb.addStationToRoute(m6, gnb.addStation(125,"Charles de Gaulle, Étoile"), 0);
			...
			gnb.addStationToRoute(m6, gnb.addStation(132,"La Motte Picquet, Grenelle"), 0);
			gnb.addStationToRoute(m6, gnb.addStation(133,"Cambronne"), 0);
			gnb.addStationToRoute(m6, gnb.addStation(134,"Sèvres Lecourbe"), 0);
			gnb.addStationToRoute(m6, gnb.addStation(135,"Pasteur"), 0);
			gnb.addStationToRoute(m6, gnb.addStation(136,"Montparnasse Bienvenue"), 0);
			gnb.addStationToRoute(m6, gnb.addStation(137,"Edgar Quinet"), 0);
			gnb.addStationToRoute(m6, gnb.addStation(138,"Raspail"), 0);
			gnb.addStationToRoute(m6, gnb.addStation(139,"Denfert Rochereau"), 0);
			...
			gnb.addStationToRoute(m6, gnb.addStation(146,"Quai de la Gare"), 0);
			...
			gnb.addStationToRoute(m7, gnb.addStation(153,"La Courneuve, 8 Mai 1945"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(154,"Fort d'Aubervilliers"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(155,"Aubervilliers-Pantin, Quatre Chemins"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(156,"Porte de la Villette"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(157,"Corentin-Cariou"), 0);
			...
			gnb.addStationToRoute(m7, gnb.addStation(167,"Chaussée d'Antin, La Fayette"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(168,"Opéra"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(169,"Pyramides"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(170,"Palais Royal, Musée du Louvre"), 0);
			...
			gnb.addStationToRoute(m7, gnb.addStation(177,"Censier Daubenton"), 0);
			...
			gnb.addStationToRoute(m7, gnb.addStation(183,"Porte de Choisy"), 0);
			...
			gnb.addStationToRoute(m7, gnb.addStation(188,"le Kremlin-Bicêtre"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(189,"Villejuif, Léo Lagrange"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(190,"Villejuif, P. Vaillant Couturier"), 0);
			gnb.addStationToRoute(m7, gnb.addStation(191,"Villejuif, Louis Aragon"), 0);
			...
			gnb.addStationToRoute(m8, gnb.addStation(197,"La Motte Picquet, Grenelle"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(198,"École Militaire"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(199,"La Tour-Maubourg"), 0);
			...
			gnb.addStationToRoute(m8, gnb.addStation(204,"Richelieu Drouot"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(205,"Rue Montmartre, Grands Boulevards"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(206,"Bonne Nouvelle"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(207,"Strasbourg Saint-Denis"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(208,"République"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(209,"Filles du Calvaire"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(210,"Saint-Sébastien-Froissart"), 0);
			...
			gnb.addStationToRoute(m8, gnb.addStation(214,"Faidherbe-Chaligny"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(215,"Reuilly Diderot"), 0);
			...
			gnb.addStationToRoute(m8, gnb.addStation(220,"Porte de Charenton"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(221,"Liberté"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(222,"Charenton-Écoles"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(223,"École Vétérinaire de Maisons-Alfort"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(224,"Maisons-Alfort, Stade"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(225,"Maisons-Alfort les Juilliottes"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(226,"Créteil-l'Echat, Hôpital Henri Mondor"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(227,"Créteil-Université"), 0);
			gnb.addStationToRoute(m8, gnb.addStation(228,"Créteil-Préfecture"), 0);
			
			gnb.defineEntryCost(sncf.getKindFromString("RER"), 4);
/*
			gnb.linkStationBidirectional(rerC, massyPal, rerB, massyPal, 0, 42, false);
