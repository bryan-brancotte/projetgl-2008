...
public class PIGBuilderRobustesse {
	...
	public void setActualPathInGraph() {
		try {
			...
			// assertTrue("Le path actuelle ne doit pas avoir changé : un appelle à setActualPathInGraph(null) ", pigB
			// .getCurrentPathInGraph() == pig);
	...
	public void importPath() {
		try {
			...
			bob.linkStation(sncf.getRoute("RerB"), sncf.getStation(1), sncf.getRoute("RerC"), sncf.getStation(9), 2,
					20, true);
			pigB.addFront(null);
