...
public class MainAlgo {
	...
	public static void main(String[] args) {
		...
		for (int i=0;i<junctions.size();i++) {
			if (i==0)System.out.print(junctions.get(i).getStationA().getName()+junctions.get(i).getRouteA().getKindRoute().getKindOf()+" => ");
			System.out.print(junctions.get(i).getStationB().getName()+junctions.get(i).getRouteB().getKindRoute().getKindOf()+" => ");
		}
