...
import ihm.smartPhone.component.PanelHiddenDoubleBufferingSoftwear;
import ihm.smartPhone.component.UpperBar;

public abstract class PanelState2 extends PanelHiddenDoubleBufferingSoftwear {
	 ...
	 *            la barre inférieure de l'IHM
	 */
	public PanelState2(IhmReceivingPanelState father, UpperBar upperBar, LowerBar lowerBar) {
		this();
