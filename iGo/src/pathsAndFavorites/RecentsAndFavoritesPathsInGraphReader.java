...
/**
 * Interface permettant de ne pas avoir a se soucier du moyen de sauvegarde des fichiers. On peut vouloir les sauvegarder dans un fichier, dans une base de donnees, ou ailleurs.
 * 
...
public interface RecentsAndFavoritesPathsInGraphReader {
	 ...
	 * @param mrp
	 *            Le nombre maximum de chemins récents
	 */
